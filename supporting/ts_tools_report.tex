...
\begin{tabular}{lrl}
    ...
    Mode Tracking + Trust Radius & 92/71\tablefootnote{SCINE/HIP} & Continuous eigenvector tracking \\
...
\subsection{$\vv_2$ Kicking: The Primary Escape Mechanism}
\label{sec:v2_kick}
