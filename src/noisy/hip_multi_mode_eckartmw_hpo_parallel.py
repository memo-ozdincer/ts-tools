#!/usr/bin/env python
"""Bayesian Hyperparameter Optimization for HIP Multi-Mode Eckart-MW (parallel)."""
...
def hip_worker_sample(predict_fn, payload, device: str) -> Dict[str, Any]:
...
def main():
    ...
    if args.wandb and WANDB_AVAILABLE:
        wandb.init(
            ...
            tags=["hpo", "hip", "multi-mode-eckartmw", "parallel"],
        )
