...
if __name__ == "__main__":
    ...
    for i, batch in enumerate(dataloader):
        ...
        try:
            ...
            all_metrics["num_kicks"].append(dynamics_fn.num_kicks)
    ...
    if all_metrics["wallclock_time"]:
        ...
        order_counts = Counter(all_metrics["final_neg_eigvals"])
        ...
        summary = {
            ...
            "ts_success_rate": order_counts.get(1, 0) / total_samples,
